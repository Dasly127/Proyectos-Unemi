...
class MatrizEstudiantes:
    ...
    def __init__(self): 
        """
        Inicializamos una matriz de estudiantes vacía.
        """
        self.estudiantes = []
        self.next_id = 1
    ...
    def agregar_estudiante(self):  
        ...
        #Creamos una función para ingresar un nuevo estudiante a la lista.
        
        cedula = input("Ingrese la cédula del estudiante (10 dígitos): ")
        if len(cedula) == 10:

# Utilizamos la función .upper() para convertir los nombres de los estudiantes de minúsculas a mayúsculas
    ...
    def modificar_estudiante(self):
        ...
        # Creamos una función para modificar los datos de un estudiante existente.
...
# Bucle para ejecutar las opciones acorde lo que elija el usuario con control de fallos
