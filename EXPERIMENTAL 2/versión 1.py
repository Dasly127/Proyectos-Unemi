...
class MatrizVendedores:
    ...
    def establecer_valor_venta_minimo(self):
        #Metodo para asignar valor de venta minimo
        self.valor_venta_minimo = float(input("Ingrese el valor de venta minimo: "))
        print(f"Valor de venta minimo establecido en: {self.valor_venta_minimo}")
