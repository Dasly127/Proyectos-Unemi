class PILASNUM:
    ...
    def obtener_numeros(self, cantidad, nombre_pila):
        """
        Solicita al usuario una cantidad específica de números para llenar una pila.
        
        Args:
            cantidad (int): Número de elementos a ingresar en la pila.
            nombre_pila (str): Nombre de la pila para mostrar al usuario.
