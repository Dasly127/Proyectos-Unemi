...
# Función para mostrar todos los productos y proveedores
def mostrar_todos():
    print("\n--- PROVEEDORES ---")
...
def mostrar_menu():
    ...
    print("3. Mostrar todos los productos y proveedores")
    print("4. Salir")
...
def main():
    while True:
        ...
        if opcion == '1':
            ...
            mostrar_todos()  # Mostrar todos los productos y proveedores
        elif opcion == '4':
