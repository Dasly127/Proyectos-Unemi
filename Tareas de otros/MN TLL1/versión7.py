...
# Datos del problema (Características del edificio) - solo 10 muestras
X = np.array([
...
# Respuestas: Cargas de calefacción (Y1) y enfriamiento (Y2) - 10 muestras
Y1 = np.array([15.55, 20.84, 19.50, 19.95, 15.55, 21.46, 20.71, 19.68, 19.50, 19.95])
Y2 = np.array([21.33, 28.28, 25.38, 25.16, 21.97, 21.33, 21.33, 21.33, 21.33, 21.33])
