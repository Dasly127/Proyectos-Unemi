...
class Nodo:
    def __init__(self, codigo, nombre, estado):
        self._datos = f"{codigo}/{nombre}/{estado}"  # Atributo privado
        self._siguiente = None  # Apuntador al siguiente nodo
...
class ListaEnlazada:
    def __init__(self):
        self._cabeza = None  # Atributo privado

    # Métodos para validar el estado, insertar, modificar y consultar
